...
<section>
    ...
    <!-- Modal -->
    <div class="modal fade" id="add_topic" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    ...
                    <form action="controllers/assignment/inser_topic_controller.php" method="post">
                        <div class="mb-4">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" class="form-control border-0 bg-light rounded-end ps-1" placeholder="Inter your topic" id="exampleInputtopic" name="topic">
    ...
    <div class="container">
        ...
        <div class="tab-content" id="course-pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="course-pills-tabs-1" role="tabpanel" aria-labelledby="course-pills-tab-1">
                <div class="d-flex">
                    <div>
                        <div class="card shadow-lg border border-secondary m-3 bg-primary-soft-hover" style="width: 12rem;">
                    ...
                    <div>
                        ...
                        ?>
                            <div class="card  shadow-lg m-3 border border-secondary bg-primary-soft-hover" style="width: 205%;">
                                ...
                                <div class="d-flex justify-content-sm-between ">
                                    ...
                                    <div class="dropdown ms-1 ms-lg-0">
                                        ...
                                        <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3 p-2">
                                            <button data-toggle="model" data-target="#rename_topic" class="bg-primary-soft-hover p-2 btn w-100"><a href="../../controllers/assignment/delete_topic.controller.php?id=<?= $topic['topic_id'] ?>">Delete</a></button>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-between p-4 m-2 dropdown-item" style="height: 80px; border-bottom: 1px solid black; ">
                            ...
                            <div class="right">
                                <div class="dropdown ms-1 ms-lg-0">
                                    ...
                                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
                                        <!-- option here -->
                                        <li><a class="dropdown-item" href="controllers/page_class_each_class.cntroller/delete_steudent.php?id=<?= $member['classroommember_id']; ?>&class=<?= $_GET['id'] ?>">Remove</a>
                                        </li>
                                        <li><a class="dropdown-item" href="https://mail.google.com/mail/u/0/?fs=1&to=<?= $member['user_email'] ?>&tf=cm">Email
                                                <?= $member['user_email'] ?>
                                            </a></li>
