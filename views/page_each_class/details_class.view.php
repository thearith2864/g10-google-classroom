	...
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-lg-8 mx-auto text-center">
				<h2 class="fs-1">In My Class</h2>
				<p class="mb-0">Here is all of imformation </p>
			</div>
		</div>
		...
		<div class="tab-content" id="course-pills-tabContent">
            ...
            <div>
                ...
                <div>
                    <div class="card w-100 shadow-lg m-3 border border-secondary nav nav-pills nav-pills-bg-soft">
                        <div class="card-body d-flex">
                            <div >
                                <i class="bi bi-file-earmark-medical-fill fa-3x m-3"></i>
                            </div>
                            <div class="p-2 w-100" >
                                <h5 class="card-title">Name Assignment</h5>
                                <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>  
                            </div>
